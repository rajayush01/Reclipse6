...
export default function Films() {
  return (
    <main className="min-h-screen bg-[#f5f2ec] text-[#1e1e1c]">
      ...
      <section className="border-b border-black/10 px-6 py-8 md:px-12 md:py-12 lg:px-20">
        ...
        >
          ...
          <div className="mx-auto max-w-[1100px] text-center">
            ...
            <p className="mt-7 font-serif text-4xl font-light leading-[1.15] tracking-[-0.02em] md:text-5xl lg:text-6xl">
            ...
            <p className="mx-auto mt-10 max-w-[800px] text-[15px] leading-8 text-black/60 md:text-base">
              From the quiet moments before the ceremony to the
              celebrations surrounded by family, music and tradition,
              we capture the emotions that make your Indian wedding
              uniquely yours.
            </p>
